...
class TutorListModel{
    var Status:String
    var Msg:String
    var data:[arrTutorListModel]

    init(Status:String, Msg:String, data:[arrTutorListModel]) {
        self.Status = Status
        self.Msg = Msg
        self.data = data
    }
...
class arrTutorListModel {
    ...
    init(StudentID:Int, Rating:String, StudentName:String, Remarks:String, DateTime:String) {
