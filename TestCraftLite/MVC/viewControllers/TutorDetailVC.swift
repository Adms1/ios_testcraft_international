...
class TutorDetailVC: UIViewController,ActivityIndicatorPresenter,UITextFieldDelegate,UIScrollViewDelegate {
    ...
    @IBOutlet weak var btnTutorStar:UIButton!
    ...
    override func viewDidLoad() {
       ...
       // tblTutorList.isScrollEnabled = false

        self.tableViewHeightConstraint.priority = UILayoutPriority(rawValue: 750)

        Analytics.logEvent("TutorDetails", parameters: nil)
        self.tblTutorList.showsHorizontalScrollIndicator=false
        self.tblTutorList.showsVerticalScrollIndicator=false
...
//            self.tblTutorList.bounces = true
        ...
        tblTutorList.register(UINib(nibName: "MyTutorDetailCell", bundle: nil), forCellReuseIdentifier: "MyTutorDetailCell")
    }
    ...
    @IBAction func btnClickTutorRating()
    {
        let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "TutorRatingVC") as? TutorRatingVC
        vc?.tutorId = tutorId
        vc?.tutorName = strTutorName
...
//            {
//                self.scrollView.contentSize = CGSize(width: self.view.frame.size.width, height: CGFloat(self.tableViewHeightConstraint.constant))
//            }else{
//                self.scrollView.contentSize = CGSize(width: self.view.frame.size.width, height: self.scrollView.contentSize.height)
//            }
////            self.tblTutorList.layoutIfNeeded()
...
//                        if(self.arrMyPackageList.count != nil) {
//                            self.tableViewHeightConstraint.constant = CGFloat(80*self.arrMyPackageList.count)
//                        }
...
//
                        ...
                        self.lblTutorName.textColor = GetColor.themeBlueColor
                        // tempory hide TutorPhoneNumber
                        self.lblTutorDesc.text = self.arrTutorList[0].TutorDescription
                        self.lblTutorDesc.textColor = UIColor.darkGray
                        self.lblTutorCount.text = "(\(self.arrTutorList[0].TotalRateCount))"
                        self.lblTutorCount.textColor = GetColor.themeBlueColor
...
extension TutorDetailVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell  = tableView.dequeueReusableCell(withIdentifier: "MyTutorDetailCell", for: indexPath) as! MyTutorDetailCell
        ...
        if arrMyPackageList.count > 1
        {
            ...
            self.tableViewHeightConstraint.constant = self.tblTutorList.frame.size.height
        }
//        cell.layoutIfNeeded()
        ...
        if arrMyPackageList.count > 0
        {
            ...
            cell.lblTestSubjectName.textColor = UIColor.darkGray
            cell.lblAttemptTotalTest.textColor = UIColor.darkGray
