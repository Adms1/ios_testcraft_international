...
class TutorVC: UIViewController ,ActivityIndicatorPresenter,UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        btnFilter.setTitleColor(GetColor.themeBlueColor, for: .normal)
//        searchText.tintColor = UIColor(red: <#T##CGFloat#>, green: <#T##CGFloat#>, blue: <#T##CGFloat#>, alpha: <#T##CGFloat#>)
...
//        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vc?.strTutorName = SearchData[indexPath.row].TutorName
        self.navigationController?.pushViewController(vc!, animated: true)
