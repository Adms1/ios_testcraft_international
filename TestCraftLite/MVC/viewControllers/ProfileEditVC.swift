...
class ProfileEditVC: UIViewController, UITextFieldDelegate, ActivityIndicatorPresenter {
    ...
    override func viewDidLoad() {
        ...
        Analytics.logEvent("ProfileUpdateScreen", parameters: nil)
        if isHiden == "1"
        {
        ...
        self.btnProfileUpdate.layer.cornerRadius = self.btnProfileUpdate.layer.frame.height / 2.0
        self.btnProfileUpdate.layer.masksToBounds = true
//        self.btnProfileUpdate.addShadowWithRadius(0,btnProfileUpdate.frame.width/9,1,color: GetColor.signInText)
        ...
        if ((UserDefaults.standard.value(forKey: "logindata")) != nil)
        {
            ...
            else
            {
                ...
                if strAccountTypeID == "7" || strAccountTypeID == "12"
                {
                    self.txtMobile.isUserInteractionEnabled = true
                    self.txtMobile.isHidden = false
                    self.txtMobile.textColor = GetColor.blackColor

                }
                if strAccountTypeID == "8" || strAccountTypeID == "13"
                {
                    self.txtMobile.isUserInteractionEnabled = true
                    self.txtMobile.isHidden = false
                    self.txtMobile.textColor = GetColor.blackColor
                ...
                if strAccountTypeID == "14" || strAccountTypeID == "9"
                {
                ...
                if strAccountTypeID == "15" || strAccountTypeID == "10"
                {
                    txtEmail.isEnabled = true
                    txtEmail.isUserInteractionEnabled = true
                    self.txtEmail.textColor = GetColor.blackColor
...
//                    self.txtMobile.isHidden = true
    ...
    @IBAction func Signup_Clicked(_ sender: UIButton) {
        ...
        Analytics.logEvent("UpdateButtonClick", parameters: nil)
