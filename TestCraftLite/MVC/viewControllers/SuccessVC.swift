...
class SuccessVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        btnDone.layer.cornerRadius = btnDone.layer.frame.height / 2.0
        btnDone.layer.masksToBounds = true
        btnDone.backgroundColor = GetColor.signInText
...
//                }
    ...
    @IBAction func Ok_Clicked(_ sender: UIButton)
    {
        ...
        Analytics.logEvent("OkButtonClick", parameters: [
                "Done_Button": "501" as NSObject
                ])
...
//                    appdelegate.window?.makeKeyAndVisible()
                    ...
                    let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "TestCraftListVC") as? TestCraftListVC
