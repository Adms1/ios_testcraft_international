...
//    @IBOutlet weak var txtOTP6: UITextField!
    ...
    override func viewDidLoad() {
        ...
        btnVerifyCode.layer.cornerRadius = btnVerifyCode.layer.frame.height / 2.0
...
//        btnVerifyCode.addShadowWithRadius(0,btnVerifyCode.frame.width/9,1,color: GetColor.signInText)
        ...
        Analytics.logEvent("VerificationCodeScreen", parameters: [
                "Verification_Code_Screen": "400" as NSObject
                ])
        print("DicReg : ",DicReg)
...
//
    ...
    @IBAction func VerifyCode_Clicked(_ sender: UIButton)
    {
        ...
        Analytics.logEvent("VerifyTheCodeButtonClick", parameters: [
                "Verify_The_Code_Button": "402" as NSObject
                ])
        view.endEditing(true)
        if validated() == true
        {
...
//                self.navigationController?.pushViewController(vc!, animated: true)
    ...
    @IBAction func Resend_Clicked(_ sender: UIButton) {
        ...
        Analytics.logEvent("ResendLinkClick", parameters: [
                "Resend_Link": "401" as NSObject
                ])
