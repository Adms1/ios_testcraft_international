...
class FilterVC: UIViewController, ActivityIndicatorPresenter {
    ...
    override func viewDidLoad() {
        ...
        btnApply.layer.cornerRadius = btnApply.layer.frame.height / 2.0

        btnApply.layer.masksToBounds = true


        btnClearAll_Down.layer.cornerRadius = btnApply.layer.frame.height / 2.0

        btnClearAll_Down.layer.masksToBounds = true
      ...
      //  btnClearAll_Down.addShadowWithRadius(0,20,0,color: UIColor.white)
       // btnClearAll_Down.backgroundColor = GetColor.lightGray
        btnClearAll_Down.backgroundColor = UIColor.lightGray
    ...
    func redioCourse(strCategoryID: String) {
        ...
        if strCategoryID == "1"
        {
            arrFilterTitle = ["Boards", "Standard", "Subjects"]
