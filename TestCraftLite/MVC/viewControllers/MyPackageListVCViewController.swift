...
class MyPackageListVCViewController: UIViewController,ActivityIndicatorPresenter ,ISRewardedVideoDelegate{
...
//        self.tblMyList.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 10.0).isActive = true
//        self.tblMyList.topAnchor.constraint(equalTo: view.topAnchor, constant: 0).isActive = true
//        self.tblMyList.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -10.0).isActive = true
//        self.tblMyList.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: 0).isActive = true
        ...
        Analytics.logEvent("TestCompletionScreen", parameters: [
            "Test_Completion_Screen": "1700" as NSObject
        ])
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.tabBarController?.tabBar.frame = CGRect(x: 0, y: view.frame.size.height - 99, width: view.frame.size.width, height: 50)

        newTabAdsView.isHidden = false
//        print("frame",newTabAdsView.frame)

//        let errorStr:String = UserDefaults.standard.string(forKey: "isTestStart") ?? ""
//        if errorStr == "startTest"
//        {
...
//            }
    ...
    @IBAction func BackClicked(_ sender: AnyObject) {
        ...
        //        arrPath.removeLast()
        Analytics.logEvent("BacktoDashboardButtonClick", parameters: nil)
...
//            super.updateViewConstraints()
       ...
       // tblMyList.layoutIfNeeded()
//        tblMyList.beginUpdates()
//        tblMyList.endUpdates()
        ...
        if isExpired == "1"{
            ...
            else if indexPath.section == 1
            {
                ...
                if cell.progressRing == nil
                {
                    ...
                    cell.progressRing = CircularProgressBar(radius: 50, position: position, innerTrackColor: GetColor.successPopupGreenColor, outerTrackColor: GetColor.lightGrayInnerStart, lineWidth: 8)
...
//                }else{
//                    if arrMyTestList.count - 1 == indexPath.row{
//                        cell.vwCreateList.roundCorners1(corners: [.bottomLeft, .bottomRight], radius: 6)
//                    }else if indexPath.row == 0{
//                        cell.vwCreateList.roundCorners1(corners: [.topLeft, .topRight], radius: 6)
//                    }
//                }
...
//                if arrMyTestList.count == 1{
//
//                    cell.vwCreateList.roundCorners1(corners: [.allCorners], withRadius: 6)
//
//                }else{
//                    if arrMyTestList.count - 1 == indexPath.row{
//                        cell.vwCreateList.roundCorners1(corners: [.bottomLeft, .bottomRight], withRadius: 6)
//                    }else if indexPath.row == 0{
//                        cell.vwCreateList.roundCorners1(corners: [.topLeft, .topRight], withRadius: 6)
//                    }
//                }


                cell.vwCreateList.backgroundColor = UIColor.clear

                cell.contentView.backgroundColor = GetColor.successPopupGreenColor
...
//                cell.layer.masksToBounds = true
            ...
            if indexPath.section == 0
            {
                ...
                {
                    //                cell.progressRing.removeFromSuperlayer()
                    cell.progressRing = CircularProgressBar(radius: 50, position: position, innerTrackColor: GetColor.successPopupGreenColor, outerTrackColor: GetColor.lightGrayInnerStart1, lineWidth: 8)
                    cell.viewProgressTestReport.layer.addSublayer(cell.progressRing)
...
//                let isLastCell = indexPath.row == arrMyTestList.count - 1
//
//                if isFirstCell && isLastCell {
//                    cell.vwCreateList.topBottomRounded()
//                }
//                else if isFirstCell {
//                    cell.vwCreateList.topRounded()
//                } else if isLastCell {
//                    cell.vwCreateList.bottomRounded()
//                }else{
//                    cell.vwCreateList.defaultStateForBorders()
//                }
//
//                cell.vwCreateList.updateConstraintsIfNeeded()
//             //   cell.vwCreateList.layoutSubviews()
...
//                }else{
//                    if arrMyTestList.count - 1 == indexPath.row{
//                        cell.vwCreateList.roundCorners1(corners: [.bottomLeft, .bottomRight], withRadius: 25)
//                    }else if indexPath.row == 0{
//                        cell.vwCreateList.roundCorners1(corners: [.topLeft, .topRight], withRadius: 25)
//                    }
//                }
                ...
                if arrMyTestList.count > 0{
                    ...
                    cell.lblTestNAme.text = arrMyTestList[indexPath.row].TestPackageName
                    cell.lblTime.text = "Time :\(arrMyTestList[indexPath.row].TestDuration)"
                    cell.lblMarks.text = "Marks :\(arrMyTestList[indexPath.row].TestMarks)"
                ...
                if arrMyTestList.count > 1 {
                    if indexPath.row == 0
                    {
                        cell.lblMyTestHeight.constant = 21
                        cell.vwTotalHeight.constant = 100
...
//    {
//        if (tableView == self.tblMyList)
//        {
//            //Top Left Right Corners
//            let maskPathTop = UIBezierPath(roundedRect: cell.bounds, byRoundingCorners: [.topLeft, .topRight], cornerRadii: CGSize(width: 6.0, height: 6.0))
//            let shapeLayerTop = CAShapeLayer()
//            shapeLayerTop.frame = cell.bounds
//            shapeLayerTop.path = maskPathTop.cgPath
//
//            //Bottom Left Right Corners
//            let maskPathBottom = UIBezierPath(roundedRect: cell.bounds, byRoundingCorners: [.bottomLeft, .bottomRight], cornerRadii: CGSize(width: 6.0, height: 6.0))
//            let shapeLayerBottom = CAShapeLayer()
//            shapeLayerBottom.frame = cell.bounds
//            shapeLayerBottom.path = maskPathBottom.cgPath
//
//            //All Corners
//            let maskPathAll = UIBezierPath(roundedRect: cell.bounds, byRoundingCorners: [.topLeft, .topRight, .bottomRight, .bottomLeft], cornerRadii: CGSize(width: 6.0, height: 6.0))
//            let shapeLayerAll = CAShapeLayer()
//            shapeLayerAll.frame = cell.bounds
//            shapeLayerAll.path = maskPathAll.cgPath
//
//            if (indexPath.row == 0 && indexPath.row == tableView.numberOfRows(inSection: 3)-1)
//            {
...
//            }
//            else if (indexPath.row == tableView.numberOfRows(inSection: 3)-1)
//            {
...
//    }
    ...
    {
        if arrMyTestList.count - 1 == indexPath.row{
            cell.contentView.roundCorners1(corners: [.bottomLeft, .bottomRight], withRadius: 6)
        }else if indexPath.row == 0{
            cell.contentView.roundCorners1(corners: [.topLeft, .topRight], withRadius: 6)
        }
...
//    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
//
//            cell.backgroundColor = GetColor.successPopupGreenColor
//            cell.layer.masksToBounds = true
        ...
        if isExpired == "1"{
            ...
            if (indexPath.section  == 5){
                ...
                if arrMyPackageList[indexPath.row].IsFree == "1"
                {
                    ...
                    if arrMyPackageList[indexPath.row].StatusName == "Start Test"{
                        Analytics.logEvent("StartTestButtonClick", parameters: nil)
                        ...
                        Analytics.logEvent("Analysis", parameters: [
                            "Analysis": "1901" as NSObject
                        ])
            ...
            if (indexPath.section  == 4){
                ...
                if arrMyPackageList[indexPath.row].IsFree == "1"
                {
                    ...
                    if arrMyPackageList[indexPath.row].StatusName == "Start Test"{
                        isAddShowIndexPath = indexPath.row
                        Analytics.logEvent("StartTestButtonClick", parameters: nil)


                        let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "TestListVC") as? TestListVC
                        vc!.arrTestList1 = [self.arrMyPackageList[isAddShowIndexPath]]
                        //        strCategoryID2 = arrHeaderSub1Title[indexPath.item].id ?? ""
                        //        strCategoryTitle2 = arrHeaderSub1Title[indexPath.item].title ?? ""
                        //        arrPath.append(arrHeaderSub1Title[indexPath.item].title ?? "")
                        isSubscription = ""
                        vc!.strPackageID = "\(arrMyPackageList[isAddShowIndexPath].TestID)"
                        vc!.strSetTitle = "\(arrMyPackageList[isAddShowIndexPath].TestName)"//TestPackageName
                        self.navigationController?.pushViewController(vc!, animated: true)
                        ...
                        vc?.arrTestData = [arrMyPackageList[indexPath.row]]
                        vc?.strTestID = "\(arrMyPackageList[indexPath.row].TestID)"
                        vc?.strTestTitle = "\(arrMyPackageList[indexPath.row].TestName ?? "")"
                        vc?.strStudentTestID = "\(arrMyPackageList[indexPath.row].StudentTestID ?? 0)"
                        vc?.int_Total_Hint = Int(arrMyPackageList[indexPath.row].NumberOfHint) ?? 0
                        vc?.int_Used_Hint = Int(arrMyPackageList[indexPath.row].NumberOfHintUsed) ?? 0
                        self.navigationController?.pushViewController(vc!, animated: true)
...
//                        newTabAdsView.isHidden = true
                        ...
                        let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "ReportVC") as? ReportVC
                        vc!.strTestID = "\(arrMyTestList[indexPath.row].TestID)"
                        vc!.strStudentTestID = "\(arrMyTestList[indexPath.row].StudentTestID)"
                        vc!.strTitle = "\(arrMyTestList[indexPath.row].TestName)"
                        self.tabBarController?.tabBar.isHidden = true
                        self.navigationController?.pushViewController(vc!, animated: true)
...
extension MyPackageListVCViewController{
    @objc func TestReportClicked(sender:UIButton) {
        ...
        if self.GivenTest == "0"{
            ...
            Analytics.logEvent("KnowledgeGapClick", parameters: [
                "Knowledge_Gap": "1701" as NSObject
            ])
    ...
    @objc func CreateTestClicked(sender:UIButton) {
        ...
        else
        {
            ...
            Analytics.logEvent("CreateTestClick", parameters: [
                "Create_my_test_button": "4300" as NSObject
            ])
            ...
            if strIsCompetitive == "True" || strIsCompetitive == "true"
            {
                strTemp = "1"
                let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "CreateTestCompetitveVC") as? CreateTestCompetitveVC
                vc?.strTitle            = self.strSubjectTitle
                vc?.strtempBoardID      = self.strtempBoardID
                vc?.strtempSubjectID    = self.strtempSubjectID
                vc?.strIsCompetitive    = strTemp
                vc?.strtempStandardID   = self.strtempStandardID
    ...
    @objc func TestSummaryReportClicked(sender:UIButton) {
        ...
        if self.GivenTest != "0"{
            Analytics.logEvent("TestSummaryReportButtonClick", parameters: nil)
            let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "InvoiceListVC") as? InvoiceListVC
...
extension MyPackageListVCViewController{
    ...
    func Insert_StudentSubscription_API_Buy_Expired_package(CourseID:String, BoardID:String, StandardID:String, TypeID:String)
    {
        ...
        Analytics.logEvent("SubscriptionPayButton", parameters: [
            "Subscription_Pay_Button": "4201" as NSObject
        ])
...
//    func roundCorners1(_ corners: UIRectCorner, radius: CGFloat) {
//        if #available(iOS 11, *) {
//            var cornerMask = CACornerMask()
//            if(corners.contains(.topLeft)){
//                cornerMask.insert(.layerMinXMinYCorner)
...
//    }
    ...
    func roundCorners1(corners: UIRectCorner, withRadius radius: CGFloat) {
