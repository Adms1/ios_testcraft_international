...
class IntroVC: UIViewController, ActivityIndicatorPresenter, GIDSignInDelegate, UITextFieldDelegate  {
    ...
    override func viewDidLoad() {
        ...
        if ((UserDefaults.standard.value(forKey: "TrackTokenID")) != nil)
        {
            ...
            Analytics.logEvent("LoginScreen", parameters: [
                    "Intro_Screen": "200" as NSObject
                    ])
        }
        else
        {
    ...
    @IBAction func Back_Clicked1(_ sender: UIButton) {
        Analytics.logEvent("LoginScreenCloseIconClick", parameters: nil)
...
//        Analytics.logEvent("Intro Screen", parameters: [
//                "Intro_Screen": "200" as NSObject
//                ])
    ...
    @IBAction func Email_Clicked(_ sender: UIButton) {
        ...
        Analytics.logEvent("Continue with Mobile", parameters: [
                "Continue_with_Mobile": "203" as NSObject
                ])
        //
    ...
    @IBAction func Phone_Clicked(_ sender: UIButton) {
        ...
        api_Activity_Action(Type: "1", gameid: "", gamesessionid: "\(UserDefaults.standard.value(forKey: "TrackTokenID") ?? "")", actionid: "203", comment: "Continue with Mobile", isFirstTime: "0")
        Analytics.logEvent("ContinuewithPhoneClick", parameters: [
                "Continue_with_Mobile": "203" as NSObject
                ])
    ...
    @IBAction func Facebook_Login_Clicked(_ sender: UIButton) {
        ...
        Analytics.logEvent("ContinuewithFacebookClick", parameters: [
                "Continue_with_Facebook": "201" as NSObject
                ])
    ...
    @IBAction func Google_Login_Clicked(_ sender: UIButton) {
        ...
        Analytics.logEvent("ContinuewithGmailClick", parameters: [
                "Continue_with_Gmail": "202" as NSObject
                ])
        GIDSignIn.sharedInstance().signIn()
        //     GIDSignIn.sharedInstance()?.presentingViewController = self
        //    // Automatically sign in the user.
            ...
            else
            {
                ...
                if email != ""
                {
                    ...
                    if CountryCode == "IN"
                    {
                        ...
                        self.called_Check_Email_API(St_ID: "0", St_FirstName: givenName , St_LastName: familyName, St_Email: email, St_Password: "", St_Mobile: "", St_AccountTypeID: "13", St_apple_user_id: "")
                        }
                    }
                }else
                {
    ...
    func called_Check_Email_API(St_ID:String, St_FirstName:String, St_LastName:String, St_Email:String,St_Password:String, St_Mobile:String,St_AccountTypeID:String,St_apple_user_id:String)
    {
        ...
        if St_AccountTypeID == "14" || St_AccountTypeID == "9"
        {
    ...
    func sign(_ signIn: GIDSignIn!, didSignInFor user: GIDGoogleUser!, withError error: Error!)
    {
        if (error == nil) {
            ...
            if CountryCode == "IN"
            {
                ...
                self.called_Check_Email_API(St_ID: "0", St_FirstName: givenName , St_LastName: familyName , St_Email: email , St_Password: "", St_Mobile: "", St_AccountTypeID: "12", St_apple_user_id: "")
                }
            }
    ...
    func authorizationController(controller: ASAuthorizationController, didCompleteWithAuthorization authorization: ASAuthorization) {
        if let appleIDCredential = authorization.credential as? ASAuthorizationAppleIDCredential {
            ...
            if CountryCode == "IN"
            {
                ...
                self.called_Check_Email_API(St_ID: "0", St_FirstName: userfirst_name , St_LastName: userlast_name, St_Email: useremail, St_Password: "", St_Mobile: "", St_AccountTypeID: "14", St_apple_user_id: userIdentifier)
                }
            }
