...
class DashboardVC: UIViewController , ActivityIndicatorPresenter ,ISRewardedVideoDelegate,ISImpressionDataDelegate,ISBannerDelegate{
...
//        UIBarButtonItem.appearance().tintColor = UIColor.red
        ...
        if UserDefaults.standard.object(forKey: "isLogin") != nil{
            ...
            if(result == "1")
            {
               // Analytics.logEvent("DashboardScreen", parameters:nil)
                Analytics.logEvent("DashboardScreen", parameters: [
                        "Dashboard": "810" as NSObject
                        ])
...
//                  }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        UserDefaults.standard.setValue("", forKey: "isTestStart")
        ...
        vc!.strSubjectTitle = "\(arrMyPackageList[indexPath.row].Name ?? "")"
