...
//                    newTabAdsView.frame = CGRect(x: 0, y: view.frame.size.height - 49, width: view.frame.size.width, height: 49)
//                self.view.addSubview(newTabAdsView)
//
//                self.tabBarController?.tabBar.frame = CGRect(x: 0, y: 0, width: view.frame.size.width, height: 49)
//                newTabAdsView.bringSubviewToFront(self.tabBarController!.tabBar)
//
//
//        //        tbbar.tabBar.isUserInteractionEnabled = true
//        //        tbbar.
//
...
//            }
        ...
        Analytics.logEvent("ScoreSolutionsScreen", parameters: nil)
...
//        }
    ...
    @IBAction func SWAnalysis_Clicked(_ sender: UIButton)
    {
        ...
        Analytics.logEvent("StrengthsWeaknessesClick", parameters: nil)
    ...
    @IBAction func TestSummaryReportSolution_Clicked(_ sender: UIButton)
    {
        ...
        Analytics.logEvent("SummaryReportClick", parameters: [
                "Summary_Report_Click": "2302" as NSObject
                ])
...
//                    self.navigationController?.pushViewController(vc!, animated: false)
    ...
    @IBAction func Solution_Clicked(_ sender: UIButton)
    {
        //                self.navigationController?.popViewController(animated: false)
        api_Activity_Action(Type: "1", gameid: "", gamesessionid: "\(UserDefaults.standard.value(forKey: "TrackTokenID") ?? "")", actionid: "2301", comment: "View Solutions Button", isFirstTime: "0")
        Analytics.logEvent("ViewSolutionsButtonClick", parameters: nil)
            ...
            case .success(let value):
                ...
                if(json["Status"] == "true" || json["Status"] == "1") {
                    ...
                    for value in arrData! {
                        ...
                        if AIR != "" {
                            self.lblYourRankIs.text = "AIR: \(value["AIR"].stringValue)"
                        } else
                        {
                            self.lblYourRankIs.text = "Internal Rank: \(value["InternalRank"].stringValue)"
                        }
