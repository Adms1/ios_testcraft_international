...
//        }
        ...
        else
        {
            ...
            if Int(strTotalGetMarks)! == 0
            {
                ...
                btnReport.isHidden = true
              //  GetColor.successPopupGreenColor
                ...
                btnGotoDashboard.setTitleColor(GetColor.grennColor, for: .normal)

                viewPopup.backgroundColor = GetColor.grennColor
                lblResult.text = "PASS"
...
//            }
    ...
    @IBAction func Solution_Clicked(_ sender: UIButton)
    {
        ...
        Analytics.logEvent("ScoreandSolutionsButtonClick", parameters: [
                "Score_and_Solutions": "2201" as NSObject
                ])
