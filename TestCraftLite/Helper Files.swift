...
var razorpayKey = "rzp_test_64hO7Ygglff1mX" //test
...
struct API {
    ...
    static let strGameID:String   = "D1328D16-0C0E-4793-8304-38006B4DB4C3"
    ...
    static let verifyReceiptURLInappPurchase:String    = "\(bundleDisplayName == "TestCraft" ? "https://buy.itunes.apple.com/verifyReceipt" : "https://sandbox.itunes.apple.com/verifyReceipt/")" //"LIVE" : "TEST"
...
//    static let getsessionIDCreateApi:String                        = "http://izumlabs.com/getsession.asp?gameid=\(izumlabsToken)"
    ...
    static let KnowledgeGepReport:String     = "\(hostName)SubjectSummaryReport.aspx?RL"
...
//    static let deleteDeviceDetailStaffApi:String                     = "\(baseUrl)DeleteDeviceDetailStaff"
    ...
    static let Get_TutorRating:String                       = "\(baseUrl)Get_TutorRating"
    static let Insert_TutorRating:String                       = "\(baseUrl)Insert_TutorRating"
    ...
    static let Get_Subcription_Course_Price_International:String                       = "\(baseUrl)Get_Subcription_Course_Price_International"

    static let Get_Board_Course_List:String                       = "\(baseUrl)Get_Board_Course_List"

    static let Get_Board_Course_List_International:String                       = "\(baseUrl)Get_Board_Course_List_International"
...
struct GetColor {
    ...
    static var lightGrayInnerStart1:UIColor                = UIColor(rgb: 0xe3e1e3)
    ...
    static var grennColor:UIColor   = UIColor(rgb: 0x47831f)
